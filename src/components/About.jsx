  ...
  const data = [
    {
      ...
      description: "React, Python, SQL, JavaScript, HTML, CSS",
    },
    {
      name: "Education",
      icon1: "./assets/edu-icon.png",
      icon2: "./assets/edu-icon-dark.png",
      description: "Undergraduate at Calvin Institute of Technology",
    },
    {
      name: "Projects",
      icon1: "./assets/project-icon.png",
      icon2: "./assets/project-icon-dark.png",
      description: "Built multiple frontend and React-based projects",
    },
  ];
